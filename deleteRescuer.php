...
<body>
 <header id="mainHeader">
     ...
     <div>
     	<p>Are you sure, Do you want deletes <?php echo "#".$_GET['deleteID'] ." ". $_GET['deleteFname']." ".$_GET['deleteLname'] ?> </p>
...
$queryDelete = "DELETE FROM rescuer WHERE rescuer.rescuer_id = '".$last_id_delete."'";
